...
page_title: "prefixsize function - terraform-provider-iputils"
subcategory: ""
description: |-
...
Returns the size of the IP prefix
...
```text
prefixsize(prefix string) number
```

## Arguments

<!-- arguments generated by tfplugindocs -->
1. `prefix` (String) IP prefix in CIDR notation (ipv4 or ipv6)
